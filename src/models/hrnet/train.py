...
CONFIG_PATH = 'soccernet-calibration-sportlight/src/models/hrnet/train_config.yaml'
...
def train(cfg: DictConfig):
    ...
    save_dir = f'soccernet-calibration-sportlight/data/experiments/{experiment_name}_{run_name}'
    metrics = [
